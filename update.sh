...
docker cp trytond-4.8.4/trytond tryton:/usr/local/lib/python3.5/dist-packages/
docker cp config.py tryton:/usr/local/lib/python3.5/dist-packages/trytond/
docker cp protocols tryton:/usr/local/lib/python3.5/dist-packages/trytond/
